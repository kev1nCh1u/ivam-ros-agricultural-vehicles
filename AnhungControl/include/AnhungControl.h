...
#define imagePATH_Local "/ros_map/myMap_0.pgm"
...
private:
	...
	//Farm AGV
	ros::Publisher Farm_AGV_Vision_Publisher_;
	ros::Publisher Farm_AGV_Magnetic_Publisher_;
	ros::Publisher Farm_AGV_RFID_Publisher_;
	...
	//Farm AGV Pose
	std::string Farm_AGV_Vision_Pose;
	std::string Farm_AGV_RFID_Tag;
	float Farm_AGV_Magnetic_Offset;
