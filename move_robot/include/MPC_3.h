...
//8000 0.06 11 0.05 30
    const int cte_cost_weight = 9000;//8000
    const int epsi_cost_weight = 2500;//2500
    const int v_cost_weight = 100;
    const int delta_cost_weight = 45;//45
    const int a_cost_weight = 1;
...
// fg[1 + x_start + t] = x1 - (x0 + v0 * CppAD::cos(psi0) * dt);
// fg[1 + y_start + t] = y1 - (y0 + v0 * CppAD::sin(psi0) * dt);
// fg[1 + psi_start + t] = psi1 - (psi0 + (CppAD::tan(delta0) * dt) / 2.5);
// fg[1 + v_start + t] = v1 - (v0 + a0 * dt);
// fg[1 + cte_start + t] = cte1 - ((f0-y0) + (v0 * CppAD::sin(epsi0) * dt));
// fg[1 + epsi_start + t] = epsi1 - ((psi0 + psi_des0) + (CppAD::tan(delta0) * dt) / 2.5);
...
std::vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs,double v_max_loc) {
 ...
 // std::cout<<"======================================= " <<std::endl;
  ...
  //限制類型（速度限制）初始化成正負？速度（JEFF）
  for (int i = v_start; i < cte_start; i++) {
    vars_lowerbound[i] = -1.4;
    vars_upperbound[i] = 1.4;
  }
...
//cout <<"E" << endl;
  ...
  //     std::cout<<"a "<< solution.x[a_start+2] <<std::endl;
  //           std::cout<<"=====solved   3======== " <<std::endl;
  //     std::cout<<"a "<< solution.x[a_start+3] <<std::endl;
  //           std::cout<<"=====solved   4======== " <<std::endl;
  //     std::cout<<"a "<< solution.x[a_start+4] <<std::endl;
  //           std::cout<<"=====solved   5======== " <<std::endl;
  //     std::cout<<"a "<< solution.x[a_start+5] <<std::endl;
  //           std::cout<<"=====solved   6======== " <<std::endl;
  //     std::cout<<"a "<< solution.x[a_start+6] <<std::endl;
  //           std::cout<<"=====solved   7======== " <<std::endl;
  //     std::cout<<"a "<< solution.x[a_start+7] <<std::endl;
  //           std::cout<<"=====solved   8======== " <<std::endl;
  //     std::cout<<"a "<< solution.x[a_start+8] <<std::endl;
  //           std::cout<<"=====solved   9======== " <<std::endl;
  //     std::cout<<"a "<< solution.x[a_start+9] <<std::endl;
